...
*/
    ...
    renderItems(isClone?: boolean) {
        ...
        return Children.map(this.props.children, (item, index) => {
            ...
            return (
                <div {...slideProps}>
                    {this.props.shouldExpandSlide &&
                        React.cloneElement(this.props.expandButton, { tabIndex: isSelected ? 0 : -1 })}
    ...
    renderControls() {
        ...
        const controlsCount = children?.length;

        return (
            <div className="control-dots" role="tablist">
                {Children.map(children, (_, index) => {
                    return (
                        renderIndicator &&
                        renderIndicator(
                            this.changeItem(index, controlsCount),
    ...
    renderThumbs() {
        ...
        if (!this.props.showThumbs || !this.props.children || Children.count(this.props.children) <= 1) {
            return null;
        }
    ...
    render() {
        ...
        const shouldDisplayNavigation = this.props.showIndicators || this.props.showThumbs;

        const slideContainerHeight = shouldDisplayNavigation
            ? typeof this.props.slideHeight === 'string'
                ? Number(this.props.slideHeight.replace(/px|vh/, '')) - 75
                : this.props.slideHeight - 75
            : 'fit-content';

        const outerSlideContainerHeight = shouldDisplayNavigation
            ? typeof this.props.slideHeight === 'string'
                ? Number(this.props.slideHeight.replace(/px|vh/, '')) + 75
                : this.props.slideHeight + 75
            : 'fit-content';
        ...
        return (
            ...
            >
                <div
                    ...
                    // add space for thumbnails if these are to be displayed
                    ...
                    style={{
                        ...
                        // height: 465,
                        height: this.props.slideContainerHeight,
                        // height: 900
                    }}
                >
